...
public class Responsavel implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "seq_responsavel", sequenceName = "seq_responsavel_id", allocationSize = 1)
    @GeneratedValue(generator = "seq_responsavel", strategy = GenerationType.SEQUENCE)
    private Integer id;
    ...
    @JoinTable(name = "responsavelResgate",
            ...
            = @JoinColumn(name = "resgate", referencedColumnName = "id",
                    nullable = false))
    private List<Resgate> responsaveisResgates = new ArrayList<>();
    ...
    public List<Resgate> getResponsaveisResgates() {
        return responsaveisResgates;
    }

    public void setResponsaveisResgates(List<Resgate> responsaveisResgates) {
